...
# Enthought imports
from traits.api import HasTraits, Instance, Enum, Str, List, DelegatesTo, PrototypedFrom, Bool, Property, Set, on_trait_change
from traitsui.api import View, Item, ModelView, TreeEditor, TreeNode, InstanceEditor
...
class PrefmapsHandler(ModelView):
    ...
    def __init__(self, *args, **kwargs):
        super(PrefmapsHandler, self).__init__(*args, **kwargs)
        row = ['a_labels','consumerliking']
        col = ['c_labels', 'sensorydata']
        self.comb.row_set = row
        self.comb.col_set = col
