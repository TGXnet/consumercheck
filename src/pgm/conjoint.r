...
ConjointMerge <- function(structure=1, consum.attr, design.matr, list.consum.liking, response, fixed, random, facs, corr=FALSE, alpha.rand=0.1, alpha.fix=0.05, plot=FALSE) {
...
# Data merge implemented in python
ConjointNoMerge <- function(structure=1, data, response, fixed, random, facs, corr=FALSE, alpha.rand=0.1, alpha.fix=0.05, plot=FALSE) {
  #structure=1  (default structure) : Analysis of main effects, Random consumer effect AND interaction 
  #         between consumer and the main effects. 
  #        (Automized reduction in random part, NO reduction in fixed part).
  #structure=2 : Main effects AND all 2-factor interactions. 
